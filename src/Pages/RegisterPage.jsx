      ...
      <div className="backdrop-blur-xl bg-white/10 p-8 rounded-lg shadow-xl w-[450px] flex flex-col items-center border border-white/30" style={{ boxShadow: "0 10px 40px rgba(0, 0, 0, 0.2)" }}>
        {isLogin ? (
          <>
            ...
            <a href="#" className="text-gray-400 text-sm mt-5 hover:underline transition hover:text-gray-300">У вас нет учетной записи?</a>
          </>
        ) : (
          <>
            <h2 className="text-white text-2xl font-bold mb-6">Зарегистрироваться</h2>
